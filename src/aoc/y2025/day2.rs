...
mod test {
    ...
    fn examples_fst() {
        ...
        assert_eq!(Range { start: 1188511880, end: 1188511890}.sum_invalid(), 1188511885);
        assert_eq!(Range { start: 222220, end: 222225}.sum_invalid(), 222222);
        assert_eq!(Range { start: 38593856, end: 38593862}.sum_invalid(), 38593859);
    }
