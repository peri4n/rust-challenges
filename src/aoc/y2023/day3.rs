...
mod test {
    ...
    #[test]
    fn solution_fst() {
        let input = include_str!("../y2023/day3.txt");
        assert_eq!(day3_fst(input), 521601);
    }

    #[test]
    fn solution_snd() {
        let input = include_str!("../y2023/day3.txt");
        assert_eq!(day3_snd(input), 80694070);
    }
}
